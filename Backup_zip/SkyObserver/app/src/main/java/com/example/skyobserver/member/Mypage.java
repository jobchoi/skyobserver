...
public class Mypage extends AppCompatActivity {
    ...
    private class ProductWriteAsync extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... URI) {
            ...
            try {
                ...
                if (imageFilePath != null) {
                    dos.writeBytes(twoHyphens + boundary + lindEnd); // header역할
                    dos.writeBytes("Content-Disposition: form-data; name=\"imageView\";" +
                            "filename=\"" + imageFilePath.toString().trim() + "\"" + lindEnd);
                }
    ...
    protected void restoreState() {
        ...
        if (userPref.getAll().values().toString().length() > 2) {
            ...
            //profileImg.findViewById(R.id.headerimageView);
            //profileImg.setImageResource(R.drawable.common_google_signin_btn_text_light_normal_background);
        }
    }
