...
public class chungnam extends AppCompatActivity {
    ...
    public class statistics extends AsyncTask<String, Void, ArrayList<mainfragementDTO>> {
        ...
        protected void onPostExecute(ArrayList<mainfragementDTO> info) {
            ...
            entries.add(new BarEntry(0f, Float.parseFloat(info.get(6).getChungnam())));
            entries.add(new BarEntry(1f, Float.parseFloat(info.get(5).getChungnam())));
            entries.add(new BarEntry(2f, Float.parseFloat(info.get(4).getChungnam())));
            entries.add(new BarEntry(3f, Float.parseFloat(info.get(3).getChungnam())));
            entries.add(new BarEntry(4f, Float.parseFloat(info.get(2).getChungnam())));
            entries.add(new BarEntry(5f, Float.parseFloat(info.get(1).getChungnam())));
            entries.add(new BarEntry(6f, Float.parseFloat(info.get(0).getChungnam())));
