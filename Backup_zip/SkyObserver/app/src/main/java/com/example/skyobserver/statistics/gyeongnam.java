...
public class gyeongnam extends AppCompatActivity {
    ...
    public class statistics extends AsyncTask<String, Void, ArrayList<mainfragementDTO>> {
        ...
        protected void onPostExecute(ArrayList<mainfragementDTO> info) {
            ...
            entries.add(new BarEntry(0f, Float.parseFloat(info.get(6).getGyeongnam())));
            entries.add(new BarEntry(1f, Float.parseFloat(info.get(5).getGyeongnam())));
            entries.add(new BarEntry(2f, Float.parseFloat(info.get(4).getGyeongnam())));
            entries.add(new BarEntry(3f, Float.parseFloat(info.get(3).getGyeongnam())));
            entries.add(new BarEntry(4f, Float.parseFloat(info.get(2).getGyeongnam())));
            entries.add(new BarEntry(5f, Float.parseFloat(info.get(1).getGyeongnam())));
            entries.add(new BarEntry(6f, Float.parseFloat(info.get(0).getGyeongnam())));
