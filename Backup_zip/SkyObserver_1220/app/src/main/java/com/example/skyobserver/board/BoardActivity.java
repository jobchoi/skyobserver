...
*//*
    ...
    public class BoadList extends AsyncTask<String, Void, ArrayList<BoardDTO>> {
        ...
        protected ArrayList<BoardDTO> doInBackground(String... strings) {
            ...
            String url = Common.SERVER_URL+"/android/board";
            try {
                ...
                JSONArray jArr = json9.getJSONArray("boardlist");
                ...
                for (int i = 0; i < jArr.length(); i++) {
                    ...
                    String reg_date = json9.getString("ref_Date");
                    String readcount = json9.getString("readCount");
                    String ref = json9.getString("ref");
                    String re_step = json9.getString("re_Step");
                    String re_level = json9.getString("re_Lever");
                    String filename = json9.getString("filename");
                    String filepath = json9.getString("filepath");
                    String nickName = json9.getString("name");
                    String email = json9.getString("email");


                    BoardDTO boardDTO = new BoardDTO(articleno, subject, content, passwd, reg_date, readcount, ref, re_step, re_level, filename, filepath,nickName,email);
