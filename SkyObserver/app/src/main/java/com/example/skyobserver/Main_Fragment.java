...
//    ArrayList<CityDTO> data25 = new ArrayList<>();
    ...
    public void onResume() {
        ...
        if (!userPref.getString("regioncode", "null").equals("null")) {
             ...
             LinearLayout linearLayout=getView().findViewById(R.id.mainLinear);
            ...
            for (int i = 0; i < dto.size(); i++) {
                if (userPref.getString("regioncode", "").equals(dto.get(i).getCode())) {
                    ...
                    stationset.setText("측정소 : "+close.getStationName());
                    pm10set.setText(close.getPm10value());




                    GradientDrawable gradientDrawable1= (GradientDrawable) pm10set.getBackground();


                    switch (close.getPm10Grade1h()){

                        case "1":
                            gradientDrawable1.setColor(Color.rgb(0, 164, 224));
                        break;
                        case "2":
                            gradientDrawable1.setColor(Color.rgb(111   , 192, 126));
                            break;
                        case "3":
                            gradientDrawable1.setColor(Color.rgb(248   , 181, 74));
                            break;
                        case "4":
                            gradientDrawable1.setColor(Color.rgb(199, 43, 29));
                            break;

                    }

                    pm25set.setText(close.getPm25value());
                    GradientDrawable gradientDrawable2= (GradientDrawable) pm25set.getBackground();
                    switch (close.getPm25Grade1h()){
                        case "1":
                            gradientDrawable2.setColor(Color.rgb(0, 164, 224));
                            break;
                        case "2":
                            gradientDrawable2.setColor(Color.rgb(111   , 192, 126));
                            break;
                        case "3":
                            gradientDrawable2.setColor(Color.rgb(248   , 181, 74));
                            break;
                        case "4":
                            gradientDrawable2.setColor(Color.rgb(199, 43, 29));
                            break;
